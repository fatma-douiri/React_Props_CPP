...
return (
        <div style={objectStyle}>
            <div style={{ height:'250px', display:'flex', justifyContent:'space-between',flexDirection:'column', alignItems:'center',marginTop:'12px'}}>
                 <div >   {children}    </div>
                 <button onClick={alertName} style={{width:'100px'}}>click me!</button>
            </div>

            <div style={{border:'3px solid black', borderRadius:'5px', padding:'7px', height:'280px', width:'50%' ,paddingTop:'0'}}>
                 <h1> {fullName} </h1>
